...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-light">{{ __('Register New Patient') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" value="{{ old('address') }}" type="text" class="form-control @error('address') is-invalid @enderror" name="address" autocomplete="address">
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input value="{{ old('emergencey_contact') }}" id="emergencey" type="text" class="form-control @error('emergencey_contact') is-invalid @enderror" name="emergencey_contact" autocomplete="emergencey-contact">
