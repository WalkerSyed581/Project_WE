...
<div class="patientPage container-fluid ">
    ...
    <div class="mainContent patientContent patientHeader col-md-9">
        ...
        <section class=" upcoming-appointments">
            ...
            <td><a class="btn btn-primary" href="{{action('LabAppointmentController@showLabReport',['id'=>Auth::user()->id,'labAppointment_id'=>$labAppointment->id])}}">Show Lab Report</a></td>
            </tr>
        </table>
                @endforeach
            @else
